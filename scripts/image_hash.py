# Vendored verbatim from img2threejs's forge/_shared/image_hash.py (pure
# stdlib -- copied rather than cross-skill-imported). Used by verify_character.py
# as a cheap Tier-1 pre-filter (near-duplicate/echo detection against the
# reference photo), NOT for semantic drift -- pHash can't see a small-region
# swap like an accessory change, see character_bible.schema.md for why.
