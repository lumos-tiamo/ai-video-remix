#!/usr/bin/env python3
# Vendored verbatim from img2threejs's forge/stage4_review/correction_loop.py
# (pure-logic, zero-dependency module -- copied rather than cross-skill-imported
# so ai-video-remix stays self-contained). Used by verify_character.py to decide
# when to keep retrying a drifted character generation vs. stop and flag it.
