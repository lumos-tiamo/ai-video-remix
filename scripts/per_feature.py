# Vendored verbatim from img2threejs's forge/stage4_review/per_feature.py
# (pure-logic module -- copied rather than cross-skill-imported). Used by
# verify_character.py so one wrong CRITICAL claim (e.g. wrong headwear) fails
# the whole verification pass even if other claims look fine in aggregate.
